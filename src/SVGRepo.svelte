    ...
    >
        ...
        <g data-testid="main-card-body" transform="translate(0, 55)">
            <text class="description" x="25" y="-5">
                <tspan dy="1.2em" x="25">{text(svgData.description, 60)}</tspan>
            </text>
                ...
                {#if svgData.stargazers_count > 0}
                    <g transform="translate(80, 0)"
                        ...
                        <g transform="translate(20, 0)">
                            <text data-testid="stargazers" class="gray">
                                {svgData.stargazers_count}
                            </text>
                        </g>
                    </g>
                {/if}
...
{:else if svgData && svgData.type == "gist"}
    ...
    >
        ...
        <g transform="translate(25, 35)">
            ...
            <g transform="translate(25, 0)">
                <text x="0" y="0">Gist - {text(svgData.description)} </text>
            </g>
        </g>
    </svg>
{/if}
